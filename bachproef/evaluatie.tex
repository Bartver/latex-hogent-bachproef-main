\chapter{\IfLanguageName{dutch}{Resultaten}{Evaluation}}%
\label{ch:evaluatie}
...
\begin{itemize}
	...
	\item \textbf{Desktop Exclusiviteit:} De huidige oplossing is enkel bruikbaar op desktop. Omdat de standaard In-App Guidance van Salesforce momenteel niet wordt ondersteund op mobiele apparaten, is een mobiele responsieve variant van het onboarding dashboard vooralsnog niet zinvol.
